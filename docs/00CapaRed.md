---
title: Capa de Red - Teoría Completa
description: Documento completo extraído de Planificación y Administración de Redes - Tema 08
subtitle: Capa de Red - Teoría
---
...
![tema08-000.png](imagenes/tema08-000.png) ![tema08-000b.png](imagenes/tema08-000b.png)
...
![tema08-001.png](imagenes/tema08-001.png)
...
![tema08-003.png](imagenes/tema08-003.png)

### 8.1.2.2. ¿Cómo se reparten las direcciones IPv4?

![tema08-005.png](imagenes/tema08-005.png)
...
![tema08-007.png](imagenes/tema08-007.png)
...
![tema08-008.png](imagenes/tema08-008.png)
...
![tema08-008b.png](imagenes/tema08-008b.png)
...
![tema08-009.png](imagenes/tema08-009.png)
...
![tema08-010.png](imagenes/tema08-010.png)
...
![tema08-011.png](imagenes/tema08-011.png)
...
![tema08-windows-logo.png](imagenes/tema08-windows-logo.png)

::: highlight
    route print

![tema08-linux-logo.png](imagenes/tema08-linux-logo.png)
...
1.  Comprobamos la pila TCP/IP del Sistema Operativo
    ...
    > 
    > [`ping`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`127.0.0.1`{.docutils .literal .notranslate}]{.pre}
    > 
2.  Comprobamos la tarjeta de red

    > 
    > [`ping`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`192.168.1.30`{.docutils .literal .notranslate}]{.pre}
    > 
3.  Comprobamos las tablas de rutas

    > 
    > [`route`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`print`{.docutils .literal .notranslate}]{.pre} (Windows) [`route`{.docutils .literal .notranslate}]{.pre} (Linux)
    > 
4.  Comprobamos el cable

    > 
    > [`ping`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`192.168.1.1`{.docutils .literal .notranslate}]{.pre}
    > 
5.  Comprobamos la salida a Internet

    > 
    > [`ping`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`8.8.8.8`{.docutils .literal .notranslate}]{.pre}
    > 
6.  Comprobamos la resolución de nombres

    > 
    > [`ping`{.docutils .literal .notranslate}]{.pre}` `{.docutils .literal .notranslate}[`www.google.es`{.docutils .literal .notranslate}]{.pre}
    > 
...
::: figure
![tema08-020.png](imagenes/tema08-020.png)

::: figure
![tema08-021.png](imagenes/tema08-021.png)
...
::: figure
![tema08-022.png](imagenes/tema08-022.png)
...
### 8.2.1.4. Tabla de conversión de prefijos CIDR
  ...
  ------------------------------------------------------------------------------------------------------
  CIDR    Clase                        Hosts [\[1\]](#id2){#id1 .footnote-reference}   Máscara
  ------- ---------------------------- ----------------------------------------------- -----------------
...
::: figure
![tema08-024.png](imagenes/tema08-024.png)
...
::: figure
![tema08-000.png](imagenes/tema08-000.png)
...
::: figure
![tema08-025.png](imagenes/tema08-025.png)
...
::: figure
![tema08-042.png](imagenes/tema08-042.png)
...
::: figure
![tema08-043.png](imagenes/tema08-043.png)
...
::: figure
![tema08-044.png](imagenes/tema08-044.png)
...
::: figure
![tema08-045.png](imagenes/tema08-045.png)

## 8.2.4. IPv6

::: figure
![tema08-047.png](imagenes/tema08-047.png)
...
El número de direcciones IPv6 posibles es de 2^128^ ≈ 3.4 x 10^38^. Este número puede también representarse como 1632, con 32 dígitos hexadecimales, cada uno de los cuales puede tomar 16 valores (véase combinatoria).
...
[`2001:0db8:85a3:08d3:1319:8a2e:0370:7334`{.docutils .literal .notranslate}]{.pre}
...
[`2001:0db8:85a3:0000:1319:8a2e:0370:7344`{.docutils .literal .notranslate}]{.pre}

es la misma dirección que

[`2001:0db8:85a3::1319:8a2e:0370:7344`{.docutils .literal .notranslate}]{.pre}

Siguiendo esta regla, si más de dos grupos consecutivos son nulos, pueden comprimirse como [`::`{.docutils .literal .notranslate}]{.pre}. Si la dirección tiene más de una serie de grupos nulos consecutivos la compresión solo en uno de ellos. Así,

- [`2001:0DB8:0000:0000:0000:0000:1428:57ab`{.docutils .literal .notranslate}]{.pre}
- [`2001:0DB8:0000:0000:0000::1428:57ab`{.docutils .literal .notranslate}]{.pre}
- [`2001:0DB8:0:0:0:0:1428:57ab`{.docutils .literal .notranslate}]{.pre}
- [`2001:0DB8:0::0:1428:57ab`{.docutils .literal .notranslate}]{.pre}
- [`2001:0DB8::1428:57ab`{.docutils .literal .notranslate}]{.pre}

son todas válidas y significan lo mismo, pero

[`2001::25de::cade`{.docutils .literal .notranslate}]{.pre}
...
[`2001:0DB8:02de::0e13`{.docutils .literal .notranslate}]{.pre}

es lo mismo que

[`2001:DB8:2de::e13`{.docutils .literal .notranslate}]{.pre}

Si la dirección es una dirección IPv4 camuflada, los últimos 32 bits pueden escribirse en base decimal; así,

[`::ffff:192.168.89.9`{.docutils .literal .notranslate}]{.pre}

es lo mismo que

[`::ffff:c0a8:5909`{.docutils .literal .notranslate}]{.pre}

pero no lo mismo que

- [`::192.168.89.9`{.docutils .literal .notranslate}]{.pre}
- [`::c0a8:5909`{.docutils .literal .notranslate}]{.pre}

El formato [`::ffff:1.2.3.4`{.docutils .literal .notranslate}]{.pre} se denomina dirección **IPv4 mapeada**, y el formato [`::1.2.3.4`{.docutils .literal .notranslate}]{.pre} dirección **IPv4 compatible**.

Las direcciones IPv4 pueden ser transformadas fácilmente al formato IPv6. Por ejemplo, si la dirección decimal IPv4 es [`135.75.43.52`{.docutils .literal .notranslate}]{.pre} (en hexadecimal, [`0x874B2B34`{.docutils .literal .notranslate}]{.pre}), puede ser convertida a [`0000:0000:0000:0000:0000:0000:874B:2B34`{.docutils .literal .notranslate}]{.pre} o [`::874B:2B34`{.docutils .literal .notranslate}]{.pre}. Entonces, uno puede usar la notación mixta dirección IPv4 compatible, en cuyo caso la dirección debería ser [`::135.75.43.52`{.docutils .literal .notranslate}]{.pre}. Este tipo de dirección IPv4 compatible casi no está siendo utilizada en la práctica, aunque los estándares no la han declarado obsoleta.
...
![tema08-048.png](imagenes/tema08-048.png)
...
::: figure
![tema08-050.png](imagenes/tema08-050.png)
...
::: figure
![tema08-051.png](imagenes/tema08-051.png)

### 8.3.1.1. Conexiones

::: figure
![tema08-052.png](imagenes/tema08-052.png)
...
::: figure
![tema08-053.png](imagenes/tema08-053.png)
...
*Documento extraído de: [Planificación y Administración de Redes - Tema 08](https://planificacionadministracionredes.readthedocs.io/es/latest/Tema08/Teoria.html)*
