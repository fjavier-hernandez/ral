...
!!! important "<span style='font-size: 1.3em;'><strong>NOTA IMPORTANTE</strong></span>"
    <span style="font-size: 1.2em;">
...
!!! info "<span style='font-size: 1.3em;'><strong>Características del cable coaxial</strong></span>"
    <span style="font-size: 1.2em;">
...
<!-- | Tipo de cable | Núcleo | Dieléctrico | Aplicaciones |
|---------------|--------|-------------|--------------|
| **RG-58/U** | Cobre sólido (diámetro: 0,9 mm) | Polietileno | Redes Ethernet 10BASE2 |
| **RG-58A/U** | Hilos trenzados (19 hilos de 0,18 mm) | Polietileno | Redes Ethernet 10BASE2 |
| **RG-59/U** | Cobre sólido (diámetro: 0,60 mm) | Polietileno de baja densidad compacto | Televisión por cable |
| **RG-6/U** | Cobre rojo sólido (diámetro: 0,75 mm) | Polietileno de baja densidad compacto | Televisión por cable, Internet por cable |
| **RG-8** | Cobre rojo sólido (diámetro: 2,18 mm) | Polietileno de baja densidad compacto | Redes Ethernet 10BASE5 | -->
...
Este medio tiene unas pérdidas muy bajas a largas distancias y una alta capacidad de transmisión, por lo que es la opción ideal para cubrir grandes distancias. Por ejemplo, las redes transoceánicas, que comunican continentes, hacen uso de enormes mazas de cables de fibra óptica.
...
##### 🏗️ Estructura de los cables de fibra

Según su diseño, los cables de fibra pueden ser:

**De estructura holgada:**
- Para interiores y exteriores de edificios
- El cable está compuesto por varios tubos, de entre 2 y 3 mm de diámetro, que contienen varias fibras en su interior
- El interior del tubo puede estar relleno de un gel hidrófugo para proteger la fibra
- El núcleo del cable contiene un elemento de refuerzo (varilla, hilos de aramida, etc.)

**De estructura ajustada:**
- Para interiores de edificios
- Está compuesto por una o varias fibras, cada una de las cuales tiene su propio recubrimiento
- Todas ellas están integradas en un cuerpo dieléctrico con un recubrimiento de fibras de aramida y una protección plástica exterior
...
33
```
Conectoresparalafibraóptica

Losconectoresdefibraópticatambiénsonvariados.Sirvenparalosdos
tiposdefibra(SMyMM)ypuedenconectarsemediantemecanismosde
anclaje,enroscado,presiónoelsistemadelconectorRJ,conpestaña
paraengancharsealconectorhembra.

Losprincipalestiposdeconectorparafibraópticaquepodemosen-
contrarenredessonlossiguientes:

Conexión Sistema Nºfibras Aplicacionestípicas

```
ST nclajeengiro 1 ■Redesdeárealocal
```
```
FC Rosca 1 ■Redesdedatosytelecomunicaciones
```
```
SC Presión 1
```
```
■CircuitodeTV
■Comprobacióndeequipos
```
```
LC Anclajeconpestaña^1
```
```
■RedesGigabitEthernet
■Multimedia
```
```
MU Presión 1 ■Finesmédicosymilitares
```
```
MT-RJ Anclajeconpestaña 2
```
```
■RedesGigabitEthernet
■RedesATM
```
```
MPO Presión (gru^4 paos^24 de 4 ) ■Redesconaltonúmerodeconexiones
```
...
La topología más empleada a la hora de montar una red de datos y telecomunicaciones es la topología en estrella, donde hay un núcleo por donde pasan todas las entidades para comunicarse. Este nodo central suele corresponderse con un centro de cableado, más o menos complejo, compuesto por uno o más armarios de distribución, cuyo contenido y finalidad estudiaremos más adelante.
...
En edificios de varias plantas se tiende a forzar la topología de estrella extendida que hemos descrito, haciendo que cada planta tenga un centro de distribución, llamado distribuidor de planta. Cada uno de estos centros se comunicará posteriormente con un distribuidor de edificio, creando una estrella entre todos estos núcleos.
...
* :simple-readdotcv: **AC302**. (RA2 // CE2a, CE2b // 1-3p). Realiza un esquema comparativo de los medios de transmisión guiados (cable de par trenzado, coaxial, fibra óptica), indicando:
...
* :simple-readdotcv: **AC304**. (RA4 // CE4a, CE4b // 1-3p). Investiga los principales estándares inalámbricos IEEE 802.11 (a, b, g, n, ac) y elabora una tabla comparativa con:
...
* :simple-readdotcv: **AC305**. (RA2 // CE2a, CE2b, CE2c // 1-3p). Diseña un esquema de cableado para un edificio de oficinas de 3 plantas, incluyendo:
    - Distribuidores de planta y edificio
    - Cableado horizontal y vertical
    - Medios de transmisión recomendados
    - Justificación de las decisiones tomadas

<a name="PR303"></a>

* :simple-cisco: **PR303**. (RA3 // CE3a, CE3b, CE3c // 1-10p).  
Como futuros técnicos en *Sistemas Microinformáticos y Redes*, el alumnado debe aprender a **identificar y trabajar con los diferentes medios de transmisión** mediante la práctica directa.  
En esta actividad individual, deberás **armar manualmente un latiguillo** de cable de par trenzado aplicando las terminaciones T568A y T568B, y **montar una roseta** para conexión de red.

> 🏢 **Escenario**
- **Material**: Cable de par trenzado UTP Cat 5e, conectores RJ-45, roseta, herramientas de crimpado
- **Objetivo**: Crear conexiones de red funcionales siguiendo estándares de cableado
- **Aplicación**: Instalaciones de redes locales en edificios

> 🛠️ **Tareas**

1. **Preparación del cable**:
   - Cortar cable UTP Cat 5e a la medida requerida
   - Pelar la cubierta exterior respetando los pares internos
   - Ordenar los pares según terminación T568A

2. **Armado de latiguillo**:
   - Insertar los pares en el conector RJ-45 en orden correcto
   - Crimpar el conector con la herramienta adecuada
   - Verificar la continuidad y orden de los pares

3. **Montaje de roseta**:
   - Conectar los pares del cable a la roseta
   - Seguir el código de colores estándar
   - Fijar la roseta al mecanismo de pared

4. **Verificación y documentación**:
   - Probar la continuidad con multímetro o tester de red
   - Documentar el proceso con fotografías
   - Responder a preguntas sobre terminaciones y estándares

> 🧰 **Herramientas**
- Herramientas de crimpado
- Pelacables
- Multímetro o tester de red
- Aules

<a name="PR306"></a>

* :simple-cisco: **PR306**. (RA3 // CE3a, CE3b, CE3c // 1-10p).  
Práctica de **armado manual de un latiguillo** de cable de par trenzado. El alumnado aprenderá a identificar los pares de colores, aplicar las terminaciones estándar T568A y T568B, y crimpar correctamente los conectores RJ-45.

<a name="PR307"></a>

* :simple-cisco: **PR307**. (RA3 // CE3a, CE3b, CE3c // 1-10p).  
Práctica de **montaje de una roseta** para conexión de red. El alumnado aprenderá a conectar correctamente los pares del cable a la roseta, seguir el código de colores estándar y fijar el mecanismo de pared.
